...
router.all('/', function (req, res, next) {
    ...
    RunQuery(sqlStr, function (categories) {
        ...
        RunQuery(sqlStr, function (products) {
            ...
            res.render('index', contextDict); // repsonse.. render index.html
        });
    });
});
...
router.route('/cat/:catSlug') // this is syntax catSlug, can use xyz also its just a var name
    .all(function (req, res, next) {
        if (req.params.catSlug == "all") {
            ...
            RunQuery(selectQuery, function (products) {
                ...
                RunQuery(selectQuery, function (categories) {
                    ...
                    var contextDict = { //javascript object
                        title: 'All products',
                        products: products,
                        categories: categories,
                        customer: req.user
